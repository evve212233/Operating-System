...
cat(int fd)
{
  ...
  while((n = read(fd, buf, BUFSZ)) > 0)
   6:	eb 1c                	jmp    24 <cat+0x24>
    write(1, buf, n);
   8:	a1 68 0b 00 00       	mov    0xb68,%eax
   d:	8b 55 f4             	mov    -0xc(%ebp),%edx
  10:	89 54 24 08          	mov    %edx,0x8(%esp)
  14:	89 44 24 04          	mov    %eax,0x4(%esp)
  18:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  1f:	e8 80 03 00 00       	call   3a4 <write>
void
cat(int fd)
{
  int n;
  ...
  while((n = read(fd, buf, BUFSZ)) > 0)
  24:	a1 68 0b 00 00       	mov    0xb68,%eax
  29:	c7 44 24 08 00 02 00 	movl   $0x200,0x8(%esp)
  30:	00 
  31:	89 44 24 04          	mov    %eax,0x4(%esp)
  35:	8b 45 08             	mov    0x8(%ebp),%eax
  38:	89 04 24             	mov    %eax,(%esp)
  3b:	e8 5c 03 00 00       	call   39c <read>
  40:	89 45 f4             	mov    %eax,-0xc(%ebp)
  43:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  47:	7f bf                	jg     8 <cat+0x8>
    write(1, buf, n);
  if(n < 0){
  49:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  4d:	79 19                	jns    68 <cat+0x68>
    printf(1, "cat: read error\n");
  4f:	c7 44 24 04 bf 08 00 	movl   $0x8bf,0x4(%esp)
  56:	00 
  57:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  5e:	e8 98 04 00 00       	call   4fb <printf>
    exit();
  63:	e8 1c 03 00 00       	call   384 <exit>
  }
}
  68:	c9                   	leave  
  69:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  70:	83 ec 20             	sub    $0x20,%esp
  int fd, i;

  buf = sbrk(BUFSZ);
  73:	c7 04 24 00 02 00 00 	movl   $0x200,(%esp)
  7a:	e8 8d 03 00 00       	call   40c <sbrk>
  7f:	a3 68 0b 00 00       	mov    %eax,0xb68

  if(argc <= 1){
  84:	83 7d 08 01          	cmpl   $0x1,0x8(%ebp)
  88:	7f 11                	jg     9b <main+0x31>
    cat(0);
  8a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  91:	e8 6a ff ff ff       	call   0 <cat>
    exit();
  96:	e8 e9 02 00 00       	call   384 <exit>
  }
  
  for(i = 1; i < argc; i++){
  9b:	c7 44 24 1c 01 00 00 	movl   $0x1,0x1c(%esp)
  a2:	00 
  a3:	eb 6d                	jmp    112 <main+0xa8>
    if((fd = open(argv[i], 0)) < 0){
  a5:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  a9:	c1 e0 02             	shl    $0x2,%eax
  ac:	03 45 0c             	add    0xc(%ebp),%eax
  af:	8b 00                	mov    (%eax),%eax
  b1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  b8:	00 
  b9:	89 04 24             	mov    %eax,(%esp)
  bc:	e8 03 03 00 00       	call   3c4 <open>
  c1:	89 44 24 18          	mov    %eax,0x18(%esp)
  c5:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  ca:	79 29                	jns    f5 <main+0x8b>
      printf(1, "cat: cannot open %s\n", argv[i]);
  cc:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  d0:	c1 e0 02             	shl    $0x2,%eax
  d3:	03 45 0c             	add    0xc(%ebp),%eax
  d6:	8b 00                	mov    (%eax),%eax
  d8:	89 44 24 08          	mov    %eax,0x8(%esp)
  dc:	c7 44 24 04 d0 08 00 	movl   $0x8d0,0x4(%esp)
  e3:	00 
  e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  eb:	e8 0b 04 00 00       	call   4fb <printf>
      exit();
  f0:	e8 8f 02 00 00       	call   384 <exit>
    }
    cat(fd);
  f5:	8b 44 24 18          	mov    0x18(%esp),%eax
  f9:	89 04 24             	mov    %eax,(%esp)
  fc:	e8 ff fe ff ff       	call   0 <cat>
    close(fd);
 101:	8b 44 24 18          	mov    0x18(%esp),%eax
 105:	89 04 24             	mov    %eax,(%esp)
 108:	e8 9f 02 00 00       	call   3ac <close>
  if(argc <= 1){
    cat(0);
    exit();
  }
  ...
  for(i = 1; i < argc; i++){
 10d:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
 112:	8b 44 24 1c          	mov    0x1c(%esp),%eax
 116:	3b 45 08             	cmp    0x8(%ebp),%eax
 119:	7c 8a                	jl     a5 <main+0x3b>
      exit();
    }
    cat(fd);
    close(fd);
  ...
  exit();
 11b:	e8 64 02 00 00       	call   384 <exit>
...
atoi(const char *s)
{
 ...
 32d:	7e 0a                	jle    339 <atoi+0x46>
 32f:	8b 45 08             	mov    0x8(%ebp),%eax
 332:	0f b6 00             	movzbl (%eax),%eax
 335:	3c 39                	cmp    $0x39,%al
 337:	7e c9                	jle    302 <atoi+0xf>
    n = n*10 + *s++ - '0';
  return n;
 ...
 361:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
{
  ...
  src = vsrc;
  while(n-- > 0)
 365:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
 369:	0f 9f c0             	setg   %al
 36c:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
 370:	84 c0                	test   %al,%al
 372:	75 de                	jne    352 <memmove+0x14>
    *dst++ = *src++;
  return vdst;
...
free(void *ap)
{
 ...
 6bf:	a1 64 0b 00 00       	mov    0xb64,%eax
...
free(void *ap)
{
 ...
 780:	a3 64 0b 00 00       	mov    %eax,0xb64
}
 785:	c9                   	leave  
 786:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7d3:	e8 d8 fe ff ff       	call   6b0 <free>
  return freep;
 7d8:	a1 64 0b 00 00       	mov    0xb64,%eax
}
 7dd:	c9                   	leave  
 7de:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7f1:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7f4:	a1 64 0b 00 00       	mov    0xb64,%eax
 7f9:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7fc:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 800:	75 23                	jne    825 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 802:	c7 45 f0 5c 0b 00 00 	movl   $0xb5c,-0x10(%ebp)
 809:	8b 45 f0             	mov    -0x10(%ebp),%eax
 80c:	a3 64 0b 00 00       	mov    %eax,0xb64
 811:	a1 64 0b 00 00       	mov    0xb64,%eax
 816:	a3 5c 0b 00 00       	mov    %eax,0xb5c
    base.s.size = 0;
 ...
 878:	a3 64 0b 00 00       	mov    %eax,0xb64
      return (void*)(p + 1);
 ...
 883:	eb 38                	jmp    8bd <malloc+0xde>
    ...
    if(p == freep)
 885:	a1 64 0b 00 00       	mov    0xb64,%eax
